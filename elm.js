...
Elm.Dict.make = function (_elm) {
      ...
      _v30: while (true) {
         ...
         {case "RBEmpty":
            switch (dict._0.ctor)
              ...
              break;
            case "RBNode":
            var _v38 = A2($Basics.compare,
              targetKey,
              dict._1);
              switch (_v38.ctor)
              {case "EQ":
                 return $Maybe.Just(dict._2);
                 case "GT": var _v39 = targetKey,
                   _v40 = dict._4;
                   targetKey = _v39;
                   dict = _v40;
                   continue _v30;
                 case "LT": var _v41 = targetKey,
                   _v42 = dict._3;
                   targetKey = _v41;
                   dict = _v42;
                   continue _v30;}
   ...
   dict) {
      ...
      _v233) {
         ...
         key,
         value) ? {ctor: "_Tuple2"
                  ,_0: A3(insert,key,value,t1)
                  ,_1: t2} : {ctor: "_Tuple2"
                             ,_0: t1
                             ,_1: A3(insert,key,value,t2)};
      });
      return A3(foldl,
      add,
      {ctor: "_Tuple2"
...
Elm.Elman = Elm.Elman || {};
Elm.Elman.make = function (_elm) {
   "use strict";
   _elm.Elman = _elm.Elman || {};
   if (_elm.Elman.values)
   return _elm.Elman.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $XY = Elm.XY.make(_elm);
   var maybeGroup = function (fs) {
      switch (fs.ctor)
      {case "::": switch (fs._1.ctor)
           {case "[]": return fs._0;}
           break;}
      return $Graphics$Collage.group(fs);
   };
   var collides = F2(function (l,
   r) {
      return _U.cmp($XY.norm(A2($XY._op["|-|"],
      l.pos,
      r.pos)),
      16 * 16) < 0;
   });
   var ghostForms = $Array.fromList($List.map(function ($) {
      return $Graphics$Collage.toForm(A2($Graphics$Element.image,
      32,
      32)($));
   })(_L.fromArray(["web/gfx/Ghost-Green-0.png"
                   ,"web/gfx/Ghost-Green-1.png"
                   ,"web/gfx/Ghost-Green-2.png"
                   ,"web/gfx/Ghost-Green-3.png"])));
   var berryForm = $Graphics$Collage.toForm(A3($Graphics$Element.image,
   32,
   32,
   "web/gfx/Strawberry.png"));
   var playerForms = $Array.fromList($List.map(function ($) {
      return $Graphics$Collage.toForm(A2($Graphics$Element.image,
      32,
      32)($));
   })(_L.fromArray(["web/gfx/Elman-0.png"
                   ,"web/gfx/Elman-1.png"
                   ,"web/gfx/Elman-2.png"
                   ,"web/gfx/Elman-1.png"])));
   var posL = {_: {}
   ...
   var rnd = function (xG) {
      ...
      function ($) {
         return function (_v3) {
            ...
            s = $._1;
            return A2($StateM._op[">>="],
            A2($StateM._op[":="],seedL,s),
            function (_v4) {
               var $ = _v4;
               return $StateM.$return(x);
            });
         }($Random.generate(xG)($));
      });
   };
   ...
   var tickL = {_: {}
               ...
               ,set: F2(function (r,x) {
                  return _U.replace([["tick"
                                     ,x]],
                  r);
               })};
   var updateTickM = A2($StateM._op[":>"],
   tickL,
   F2(function (x,y) {
      return x + y;
   })(1));
   ...
   var Rot$ = F2(function (a,b) {
      return _U.insert("rot",a,b);
   });
   var Form$ = F2(function (a,b) {
      return _U.insert("form",a,b);
   });
   var Spd$ = F2(function (a,b) {
      return _U.insert("spd",a,b);
   });
   var Dim$ = F2(function (a,b) {
      return _U.insert("dim",a,b);
   });
   ...
   {_: {},x: 960,y: 540},
   0.5);
   var wrapPos = $XY.zipWith(F2(function (d,
   x) {
      return _U.cmp(x,
      0 - d) < 0 ? x + 2 * d : _U.cmp(d,
      x) < 0 ? x - 2 * d : x;
   }))(gameDim);
   var updatePhysical = function (p) {
      return _U.replace([["pos"
                         ,wrapPos(A2($XY._op["|+|"],
                         p.pos,
                         p.spd))]],
   ...
   var updatePhysicsM = A2($StateM._op[">>."],
   A2($StateM._op[":>"],
   playerL,
   updatePhysical),
   A2($StateM._op[":>"],
   ghostsL,
   $List.map(updatePhysical)));
   var wrappedPos = function (r) {
      var max = A2($XY._op["|+|"],
      r.pos,
      r.dim);
      var min = A2($XY._op["|-|"],
      ...
      gameDim) && A2($XY._op["|<|"],
      $XY.neg(gameDim),
      min)) return _L.fromArray([r]);
      else {
            var mk = F2(function (x,y) {
               return _U.replace([["pos"
                                  ,A2($XY._op["|+|"],
                                  r.pos,
                                  A2($XY._op["|*|"],
            ...
            var x = sign(r.pos.x) * -2;
            var y = sign(r.pos.y) * -2;
            return _L.fromArray([A2(mk,0,0)
                                ,A2(mk,x,0)
                                ,A2(mk,0,y)
                                ,A2(mk,x,y)]);
         }
   };
   var updatePlayerM = A2($StateM._op[">>="],
   $StateM.getState,
   function (_v6) {
      var $ = _v6,
      player = $.player,
   ...
   function (_v8) {
      var $ = _v8,
      player = $.player;
      var players = wrappedPos(player);
      return $StateM.updM(berriesL)($StateM.filterM(function (berry) {
         return A2($List.any,
         collides(berry),
         players) ? A2($StateM._op[">>."],
         A2($StateM._op[":>"],
         scoreL,
         F2(function (x,y) {
            return x + y;
         })(1)),
         $StateM.$return(false)) : $StateM.$return(true);
      }));
   });
   var viewSprite = function (sprite) {
      var _v9 = sprite.form;
      switch (_v9.ctor)
      {case "Just":
         var rotf = A2($Graphics$Collage.rotate,
           sprite.rot,
           _v9._0);
           return maybeGroup($List.map(function (s) {
              return A2($XY.move,
              s.pos,
              rotf);
           })(wrappedPos(sprite)));
   ...
   A2($XY._op["|*"],gameDim,2)));
   var viewScoreAndLives = function (state) {
      return $XY.move({_: {}
                      ,x: 0
                      ,y: gameDim.y - 32})($Graphics$Collage.text($Text.fromString(A2($Basics._op["++"],
      "Score ",
      A2($Basics._op["++"],
      $Basics.toString(state.score),
      A2($Basics._op["++"],
      " - Lives ",
      $Basics.toString(state.lives)))))));
   };
   var view = function (state) {
      return A3($XY.curryTo,
      $Graphics$Element.container,
      A2($XY.map,
      $Basics.round,
      A2($XY._op["|*"],gameDim,2)),
      $Graphics$Element.middle)(A2($XY.curryTo,
   ...
   _elm.Elman.values = {_op: _op
                       ...
                       ,updatePhysicsM: updatePhysicsM
                       ,updatePlayerM: updatePlayerM
                       ,collides: collides
                       ,updateBerriesM: updateBerriesM
                       ,updateGhostsM: updateGhostsM
                       ,update: update
                       ,viewBack: viewBack
                       ,maybeGroup: maybeGroup
                       ,viewSprite: viewSprite
                       ,viewScoreAndLives: viewScoreAndLives
                       ,view: view
                       ,main: main
                       ,state: state
                       ,input: input};
...
Elm.Lens = Elm.Lens || {};
Elm.Lens.make = function (_elm) {
   "use strict";
   _elm.Lens = _elm.Lens || {};
   if (_elm.Lens.values)
   return _elm.Lens.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   yz) {
      return {_: {}
             ,get: function ($) {
                return yz.get(xy.get($));
             }
             ,set: function (x) {
                return function ($) {
                   return xy.set(x)(yz.set(xy.get(x))($));
                };
             }};
   });
   var Lens = F2(function (a,b) {
      return {_: {},get: a,set: b};
   });
   _elm.Lens.values = {_op: _op
                      ,Lens: Lens};
   return _elm.Lens.values;
};
Elm.List = Elm.List || {};
...
Elm.Random.make = function (_elm) {
   ...
   var magicNum1 = 53668;
   var magicNum0 = 40014;
   var generate = F2(function (_v1,
   seed) {
      var _raw = _v1,
      $ = _raw.ctor === "Generator" ? _raw : _U.badCase($moduleName,
      "bugs in reporting the exact location right now"),
      generator = $._0;
   ...
   var next = function (_v2) {
      var _raw = _v2,
      $ = _raw.ctor === "State" ? _raw : _U.badCase($moduleName,
      "bugs in reporting the exact location right now"),
      s1 = $._0,
      s2 = $._1;
      var k$ = s2 / magicNum3 | 0;
      var s2$ = magicNum4 * (s2 - k$ * magicNum3) - k$ * magicNum5;
      var s2$$ = _U.cmp(s2$,
      0) < 0 ? s2$ + magicNum7 : s2$;
      var k = s1 / magicNum1 | 0;
      var s1$ = magicNum0 * (s1 - k * magicNum1) - k * magicNum2;
      var s1$$ = _U.cmp(s1$,
      0) < 0 ? s1$ + magicNum6 : s1$;
      var z = s1$$ - s2$$;
      var z$ = _U.cmp(z,
   ...
   var split = function (_v3) {
      var _ = _v3;
      var s1 = function () {
         switch (_.ctor)
         {case "State": return _._0;}
         _U.badCase($moduleName,
         "bugs in reporting the exact location right now");
      }();
      var s2 = function () {
         switch (_.ctor)
         {case "State": return _._1;}
         _U.badCase($moduleName,
         "bugs in reporting the exact location right now");
      }();
      var std = function () {
...
Elm.Signal.make = function (_elm) {
   ...
   var mergeMany = function (signalList) {
      var _v4 = $List.reverse(signalList);
      switch (_v4.ctor)
      {case "::":
         return A3($List.foldl,
           merge,
...
Elm.StateM.make = function (_elm) {
   "use strict";
   _elm.StateM = _elm.StateM || {};
   if (_elm.StateM.values)
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var delay = F2(function (u2xS,
   s) {
      return A2(u2xS,
      {ctor: "_Tuple0"},
      s);
   });
   var upd = F3(function (_v0,
   x2x,
   s) {
      var $ = _v0,
      get = $.get,
      ...
      return {ctor: "_Tuple2"
             ,_0: {ctor: "_Tuple0"}
             ,_1: A2(set,s,x2x(get(s)))};
   });
   _op[":>"] = upd;
   var get = F2(function (_v1,s) {
      var $ = _v1,get = $.get;
      return {ctor: "_Tuple2"
             ,_0: get(s)
             ,_1: s};
   });
   var set = F3(function (_v2,
   x,
   s) {
      var $ = _v2,set = $.set;
      return {ctor: "_Tuple2"
   ...
   var $return = F2(function (x,
   s) {
      return {ctor: "_Tuple2"
             ,_0: x
             ,_1: s};
   });
   var when = F2(function (b,uS) {
      return b ? uS({ctor: "_Tuple0"}) : $return({ctor: "_Tuple0"});
   });
   _op[">>="] = F3(function (xS,
   x2yS,
   s) {
      return $Basics.uncurry(x2yS)(xS(s));
   });
   _op[">>."] = F2(function (xS,
   yS) {
      return A2(_op[">>="],
   ...
   var updM = F2(function (sLx,
   x2xS) {
      return A2(_op[">>="],
      A2(_op[">>="],get(sLx),x2xS),
      set(sLx));
   });
   var seq = function (ops) {
      switch (ops.ctor)
      {case "::": switch (ops._1.ctor)
           {case "[]": return ops._0;}
           return A2(_op[">>="],
           ops._0,
           function (_v8) {
         ...
         case "[]":
         return $return({ctor: "_Tuple0"});}
      _U.badCase($moduleName,
      "bugs in reporting the exact location right now");
   };
   var chooseM = function (x2yMS) {
      var lp = F2(function (ys,
      xs) {
         switch (xs.ctor)
         {case "::":
            return A2(_op[">>="],
              ...
              function (yM) {
                 switch (yM.ctor)
                 {case "Just": return A2(lp,
                      A2($List._op["::"],yM._0,ys),
                      xs._1);
                    case "Nothing": return A2(lp,
                      ys,
                      xs._1);}
                 _U.badCase($moduleName,
                 "bugs in reporting the exact location right now");
            ...
            case "[]":
            return $return($List.reverse(ys));}
         _U.badCase($moduleName,
         "bugs in reporting the exact location right now");
      });
      return lp(_L.fromArray([]));
   };
   var mapM = function (x2yS) {
      return chooseM(A2(_op[">=>"],
      x2yS,
      function ($) {
         return $return($Maybe.Just($));
      }));
   };
   var filterM = function (x2bS) {
      return chooseM(function (x) {
         return A2(_op[">>="],
         x2bS(x),
         function (b) {
            return $return(b ? $Maybe.Just(x) : $Maybe.Nothing);
         });
      });
   };
   var run = F2(function (uS,s) {
      return $Basics.snd(uS(s));
   });
   _elm.StateM.values = {_op: _op
                        ,run: run
                        ,$return: $return
                        ,getState: getState
                        ,setState: setState
...
Elm.XY.make = function (_elm) {
   ...
   r) {
      return _U.cmp(l.x,
      r.x) < 1 && _U.cmp(l.y,r.y) < 1;
   });
   _op["|<|"] = F2(function (l,r) {
      return _U.cmp(l.x,
      r.x) < 0 && _U.cmp(l.y,r.y) < 0;
   });
   var sumWith = F2(function (f,
   v) {
      return A2(f,v.x,v.y);
   });
   ...
   var dot = F2(function (l,r) {
      return sumWith(F2(function (x,
      y) {
         return x + y;
      }))(A2(_op["|*|"],l,r));
   });
   ...
   var abs = function (v) {
      return $Basics.sqrt(norm(v));
   };
   _op["|/|"] = zipWith(F2(function (x,
   y) {
      return x / y;
   }));
   var map = F2(function (f,v) {
      return _U.replace([["x"
                         ,f(v.x)]
                        ,["y",f(v.y)]],
      v);
   });
   var neg = map(F2(function (x,
   y) {
      return x * y;
   })(-1));
   var curryTo = F2(function (k,
   _v0) {
      var $ = _v0,x = $.x,y = $.y;
      return A2(k,x,y);
   });
   var ofCurry = F2(function (x,
   y) {
      return {_: {},x: x,y: y};
   });
   var ofScalar = function (n) {
      return {_: {},x: n,y: n};
   };
   _op["|*"] = F2(function (v,s) {
      return A2(_op["|*|"],
   ...
   var move = function ($) {
      return $Graphics$Collage.move(toPair($));
   };
   var diag = F2(function (z,o) {
      return {_: {}
             ,x: {_: {},x: o,y: z}
             ,y: {_: {},x: z,y: o}};
   });
   var XY$ = F3(function (a,b,c) {
      return _U.insert("y",
      b,
      _U.insert("x",a,c));
   });
   _elm.XY.values = {_op: _op
                    ,XY$: XY$
                    ,diag: diag
                    ,toPair: toPair
                    ,ofPair: ofPair
